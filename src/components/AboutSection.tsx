    ...
    <section id="about" className="py-24 bg-gradient-primary">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-6xl md:text-6xl font-serif font-bold text-center mb-16 text-foreground">
          ...
          <div className="space-y-8">
            <div className="bg-card border border-border rounded-2xl p-8 hover:shadow-glow transition-all duration-300">
              <div className="flex items-start gap-6">
                <div className="w-20 h-20 md:w-16 md:h-16 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0">
                  <Palette className="w-10 h-10 md:w-8 md:h-8 text-primary" />
                </div>
                <div className="flex-1">
                  <h3 className="text-3xl md:text-2xl font-serif font-bold mb-4 text-foreground">Creative Editor</h3>
                  <p className="text-xl md:text-base text-muted-foreground leading-relaxed mb-4">
                  ...
                  <p className="text-xl md:text-base text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card border border-border rounded-2xl p-8 hover:shadow-glow transition-all duration-300">
              <div className="flex items-start gap-6">
                <div className="w-20 h-20 md:w-16 md:h-16 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0">
                  <GraduationCap className="w-10 h-10 md:w-8 md:h-8 text-primary" />
                </div>
                <div className="flex-1">
                  <h3 className="text-3xl md:text-2xl font-serif font-bold mb-4 text-foreground">Academic Excellence</h3>
                  <p className="text-xl md:text-base text-muted-foreground leading-relaxed">
